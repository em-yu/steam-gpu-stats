...
# This is from https://github.com/sangaline/wayback-machine-scraper with a fix from this PR https://github.com/sangaline/scrapy-wayback-machine/pull/9
# code by sangaline, fix by vladkvit

# with more details on the wayback machine middleware in this blog post https://sangaline.com/post/wayback-machine-scraper/

# to use this, all we need to do is add these lines in settings.py:

# DOWNLOADER_MIDDLEWARES = {
#     'steam_stats_scraper.wayback_machine_middleware.WaybackMachineMiddleware': 5,
# }
# WAYBACK_MACHINE_TIME_RANGE = (20080101000000, 20250101000000)
...
class WaybackMachineMiddleware:
    ...
    snapshot_url_template = 'https://web.archive.org/web/{timestamp}id_/{original}' # this one points to just the html content it seems (maybe faster to load?)
    # snapshot_url_template = 'https://web.archive.org/web/{timestamp}/{original}' # this one points to the full webpage (with CSS etc)
